...
class TBT_Notes_Frontend {
	...
	protected function strings() {
		return array(
			...
			'yourClasses'       => __( 'Your classes', 'tbt-notes' ),
			'createNewClass'    => __( 'Create new class', 'tbt-notes' ),
			'searchByClass'     => __( 'Search by class or student', 'tbt-notes' ),
			'searchYourClasses' => __( 'Search your classes', 'tbt-notes' ),
			'clearSearch'       => __( 'Clear search', 'tbt-notes' ),
			'clearFilters'      => __( 'Clear filters', 'tbt-notes' ),
			/* translators: 1: classes shown, 2: classes in the list, 3: "class" or "classes". */
			'classesOf'         => __( '%1$d of %2$d %3$s', 'tbt-notes' ),
			'classOne'          => __( 'class', 'tbt-notes' ),
			'classMany'         => __( 'classes', 'tbt-notes' ),
			'noClassMatch'      => __( 'No classes match your search.', 'tbt-notes' ),
			'newClass'          => __( 'New class', 'tbt-notes' ),
			'newLesson'         => __( 'New lesson', 'tbt-notes' ),
			'newLessonShort'    => __( '+ NEW', 'tbt-notes' ),
			'newNoteTitle'      => __( 'New note', 'tbt-notes' ),
			...
			'createNote'        => __( 'Create note', 'tbt-notes' ),
			'cancel'            => __( 'Cancel', 'tbt-notes' ),
			'searchClasses'     => __( 'Search classes…', 'tbt-notes' ),
			'classTitle'        => __( 'Class name', 'tbt-notes' ),
			...
			// Class settings screen: one panel serves both creating and editing a
			// class, so the heading, the support line and the primary action all swap
			// with state.classIsNew rather than living on two separate screens.
			'classSettingsTitle' => __( 'Class settings', 'tbt-notes' ),
			'newClassSupport'   => __( 'Name the class and add the students who should see its notes. You can change both later.', 'tbt-notes' ),
			'editClassSupport'  => __( 'Change the class name or who it is shared with.', 'tbt-notes' ),
			'classTitleHint'    => __( 'Shown on the class card and at the top of every note in this class.', 'tbt-notes' ),
			'studentsHint'      => __( 'Students see the notes for this class in their own Notes page.', 'tbt-notes' ),
			'noStudentsYet'     => __( 'No students yet. Search below to add one.', 'tbt-notes' ),
			'createClass'       => __( 'Create class', 'tbt-notes' ),
			'saveChanges'       => __( 'Save changes', 'tbt-notes' ),
			'savedTag'          => __( 'Saved', 'tbt-notes' ),
			'classCreated'      => __( 'Class created', 'tbt-notes' ),
			'classCreatedBody'  => __( 'Notes you write in this class will be visible to its students.', 'tbt-notes' ),
			'openClass'         => __( 'Open class', 'tbt-notes' ),
			'backToClasses'     => __( 'Back to classes', 'tbt-notes' ),
			'backToClass'       => __( 'Back to class', 'tbt-notes' ),
